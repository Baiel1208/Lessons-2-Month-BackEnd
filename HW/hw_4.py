...
# ДЗ №4
# Berserk должен получать от босса урон, затем при ударе наносить ему свой урон, плюс часть накопленного урона полученного от босса
...
# Golem, который имеет увеличенную жизнь но слабый удар. Может принимать на себя  1/5 часть урона исходящего от босса по другим игрокам
class Golem(Hero):
    def __init__(self, name, health, damage) -> None: 
        super().__init__(name, health, damage, HACK) 
    ...
    def apply_super_power(self, damage, heroes):
        for hero in heroes:
